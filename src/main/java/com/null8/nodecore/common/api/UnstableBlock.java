...
import com.null8.nodecore.common.init.NodeCoreBlockTags;
...
public class UnstableBlock extends Block implements Fallable {
    ...
    public void tick(@NotNull BlockState p_53216_, ServerLevel p_53217_, BlockPos p_53218_, @NotNull Random p_53219_) {
        if (Util.isFree(p_53217_.getBlockState(p_53218_.below())) && p_53218_.getY() >= p_53217_.getMinBuildHeight()) {
    ...
    public void randomTick(@NotNull BlockState state, @NotNull ServerLevel level, @NotNull BlockPos pos, @NotNull Random random) {
        BlockPos fallToPos = Util.getFallFree(pos, level);
        if (fallToPos != pos) {
        ...
        if (state.is(NodeCoreBlockTags.LOOSE) && !state.is(NodeCoreBlockTags.LEAVES) && random.nextInt(3) == 0) {
    ...
    public void animateTick(@NotNull BlockState p_53221_, @NotNull Level p_53222_, @NotNull BlockPos p_53223_, Random p_53224_) {
        if (p_53224_.nextInt(16) == 0) {
            ...
            if (Util.isFree(p_53222_.getBlockState(blockpos))) {
